...
if(!defined('wplyr_video_path')){
    ...
    //https://catvusa.com/video/spots/start.video.promote.mp4
    //https://catvusa.com/video/broadcast/814m.mp4
    //https://catvusa.com/video/video.konec.mp4
    define('wplyr_video_path',$_SERVER['DOCUMENT_ROOT'] . "");
    define('wplyr_video_url',"https://catvusa.com/video");
}
...
function wp_wplyr_video_custom_script_load()
{
    ...
    wp_enqueue_script('alertify', plugin_dir_url(__FILE__) . '/node_modules/alertify/lib/alertify.min.js');
    wp_enqueue_style('alertify-stylesheet-default', plugin_dir_url(__FILE__) . '/node_modules/alertify/themes/alertify.default.css');
    wp_enqueue_style('alertify-stylesheet-core', plugin_dir_url(__FILE__) . '/node_modules/alertify/themes/alertify.core.css');
}
